...
obsidian-go-mcp is an MCP (Model Context Protocol) server that lets AI assistants interact with your Obsidian vault. It provides 67 tools for reading, writing, searching, and organizing notes.
