---
title: Security
description: Security considerations for obx.
---
...
<Aside type="caution">
Your AI assistant (Claude, etc.) can use obx tools to read and modify your vault. Consider what sensitive information might be in your notes.
</Aside>
